...
def timbral_hardness(audio_data: Dict[str, Any],
                     dev_output=False, clip_output=False, max_attack_time=0.1,
    ...
    """
    audio_samples, fs = audio_data['audio_samples'], audio_data['fs']

    '''
      Calculate the midband level
    '''
    # get the level in the midband
    midband_level, weighed_midband_level = timbral_util.weighted_bark_level(audio_data, fs, low_bark_band=70,
                                                                            upper_bark_band=140)
